          ...
          <form method="post" action="{{ route('user.update', $user) }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Ubah User') }}</h4>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('nama_user') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('nama_user') ? ' is-invalid' : '' }}" name="nama_user" id="input-name" type="text" placeholder="{{ __('Name') }}" value="{{ old('nama_user', $user->nama_user) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('nip') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('nip') ? ' is-invalid' : '' }}" name="nip" id="input-nip" type="text" placeholder="{{ __('NIP') }}" value="{{ old('nip', $user->nip) }}" required />
                      @if ($errors->has('nip'))
