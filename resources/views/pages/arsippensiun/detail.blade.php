@extends('layouts.app', ['activePage' => 'arsip-pensiun', 'titlePage' => __('Detail Informasi Pegawai Pensiun'), 'notification' => $notification])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          @foreach($detail as $pensiun)
          <form method="POST" action="{{ route('arsipp.delete') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Detail Informasi Pegawai Pensiun') }}</h4>
                <p class="card-category">Berikut adalah informasi lengkap tentang pegawai pensiun ini!</p>
              </div>
              <div class="card-body">
                <div class="row form-group">
                  ...
                  <div class="col-sm-2">
                    ...
                    <select class="form-control" data-style="btn btn-link" value="{{ $pensiun->jenis_kelamin }}" id="jenis_kelamin" name="jenis_kelamin" disabled="disabled" required readonly>
                ...
                <div class="row form-group">
                  <div class="col-sm-2">
                    ...
                    <select class="form-control" data-style="btn btn-link" value="{{ $pensiun->eselon }}" id="eselon" name="eselon" disabled="disabled" required readonly>
                      <optgroup label="Selected :">
                  ...
                  <div class="col-sm-3">
                    ...
                    <select class="form-control" data-style="btn btn-link" value="{{ $pensiun->status_kepegawaian }}" id="status_kepegawaian" name="status_kepegawaian" disabled="disabled" required readonly>
                      <optgroup label="Selected :">
                  ...
                  <div class="col-sm-1">
                    ...
                    <select class="form-control" data-style="btn btn-link" value="{{ $pensiun->gajis_id }}" id="gajis_id" name="gajis_id" disabled="disabled" required readonly>
                    <optgroup label="Selected :">
                  ...
                  <div class="col-sm-2">
                    ...
                    <select class="form-control" data-link="btn btn-link" value="{{ $pensiun->golongan }}" id="golongan" name="golongan" disabled="disabled" required readonly>
                      <optgroup label="Selected :">
                ...
                <div class="row form-group">
                  ...
                  <div class="col-sm-3">
                    ...
                    <input type="date" class="form-control" value="{{ $pensiun->tahun_pensiun }}" id="tahun_pensiun_mutasi" name="tahun_pensiun_mutasi" placeholder="Tanggal Resmi Pensiun" required readonly>
                  </div>
                </div>
              </div>
