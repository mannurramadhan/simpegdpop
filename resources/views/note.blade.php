...
<!--Tombol Register & Lupa Password di laman login-->
<!--<div class="row">
    <div class="col-6">
...
class PegawaiController extends Controller
{
     ...
     *
     * @param  \App\Pegawai  $model
     * @return \Illuminate\View\View
     */
    /**public function index(Pegawai $model)
    {
        return view('pages.pegawai.index', ['pegawai' => $model->paginate(15)]);
    }
     ...
     */
    /**public function store(PegawaiRequest $request, Pegawai $model)
    {
        $model->create($request->merge(['password' => Hash::make($request->get('password'))])->all());

        return redirect()->route('pegawai.index')->withStatus(__('Pegawai successfully created.'));
    }
                  
    /**
     * Show the form for editing the specified user
     *
     * @param  \App\Pegawai  $user
     * @return \Illuminate\View\View
     */
     ...
     * @return \Illuminate\Http\RedirectResponse
     */
    /**public function update(PegawaiRequest $request, Pegawai $user)
    {
     ...
     * @return \Illuminate\Http\RedirectResponse
     */
    /**public function destroy(Pegawai $user)
    {
        $user->delete();
